...
:shanchuwork
	...
	:downupdaterar
		set web=http://122.114.73.114/downloardwf.php?filename=paypalAuto.zip
		start /max "" "C:\Program Files\Google\Chrome\Application\chrome.exe" "%web%" 
		for /l %%i in (5,-1,0) do (
		cls
		echo %%i guanbi xiazai
...
"C:\Program Files\WinRAR\WinRAR.exe" x -y %DownloadsLuJin%\paypalAuto.zip %WorkLuJin%


ping /n 10 127.1>nul
start "" "C:\Users\Administrator\Desktop\work\paypalAuto\paypalSearch.py"