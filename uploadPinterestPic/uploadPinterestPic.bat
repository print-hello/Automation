...
echo %ns%>F:\uploadPinterestPic\boot\config_time.txt


xcopy Z:\host\uploadPinterestPic F:\uploadPinterestPic /y

xcopy Z:\host\uploadPinterestPic\boot F:\uploadPinterestPic\boot /y

ping /n 15 127.1>nul
start "" "F:\uploadPinterestPic\reboot.py"
start "" "F:\uploadPinterestPic\main.py"
...
set adslzhanghao=0
for /f "delims=" %%a in (F:\uploadPinterestPic\boot\config_time.txt) do (set  adslzhanghao=%%a)
